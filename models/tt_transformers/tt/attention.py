...
class Attention(LightweightModule):
    ...
    def _apply_partial_rope(self, x: ttnn.Tensor, rot_mats, transformation_mat, is_decode_mode: bool):
        # Full rotary: keep existing behavior
        ...
        # Partial rotary (Phi-1)
        # Split last dim: [0:rotary_dim] rotated, [rotary_dim:head_dim] passthrough
        x_rope = ttnn.slice(
            x,
            (0, 0, 0, 0),
            (x.shape[0], x.shape[1], x.shape[2], self.rotary_dim),
        )
